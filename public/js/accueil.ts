const btInscription : HTMLElement | null =  document.getElementById("btInscription"); 
const btConnection: HTMLElement | null = document.getElementById("btConnecter");
const btProfil : HTMLElement | null = document.getElementById("btProfil"); 
const btFleche : HTMLElement | null =  document.getElementById("flecheFin"); 
const fleche : HTMLElement | null = document.getElementById("flecheProfil"); 
const menu1 : HTMLElement | null =  document.getElementById("menu1"); 
...
btProfil!.addEventListener("mouseout", function(){
    if(flecheIsClick){
        (document.getElementById("flecheProfil")as HTMLElement).style.borderBottom = "15px solid #69dac2"; 
    }else{
        (document.getElementById("imageProfil")as HTMLImageElement).src = "images/profil.png"; 
        (document.getElementById("titreProfil")as HTMLElement).style.color = "white"; 
        (document.getElementById("flecheProfil")as HTMLElement).style.borderTop = "15px solid #ffffff"; 
    }
}); 
btProfil!.addEventListener("mouseover", function(){
    (document.getElementById("imageProfil")as HTMLImageElement).src = "images/profil2.png"; 
    (document.getElementById("titreProfil")as HTMLElement).style.color = "#69dac2"; 
    if(flecheIsClick){
        (document.getElementById("flecheProfil")as HTMLElement).style.borderBottom = "15px solid #69dac2"; 
    }else{
        (document.getElementById("flecheProfil")as HTMLElement)!.style.borderTop = "15px solid #69dac2"; 
    }
}); 
...
btProfil!.addEventListener("click", function(event){
    ...
    if(!flecheIsClick){
        ...
        (document.querySelector(".cadreMenu")as HTMLElement)!.style.display = 'block';
    }else{
        flecheIsClick = false; 
        fleche!.style.borderTop = "15px solid #69dac2";
        fleche!.style.borderBottom = "none";
        (document!.querySelector(".cadreMenu")as HTMLElement)!.style.display = 'none';
    }
}); 
...
window.onload = function () {
    (document.querySelector(".cadreMenu")as HTMLElement).style.left = (document.getElementById("flecheProfil")as HTMLElement).offsetLeft - 47 + "px"; 
}
