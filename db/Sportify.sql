...
CREATE TABLE `UTILISATEUR` (
  ...
  `PDP_SRC` varchar(100) DEFAULT 'http://54.162.237.63/public/images/utilisateur.png',
  `BADGE_SRC` varchar(100) DEFAULT 'http://54.162.237.63/public/images/badge.png',
  `ECUSSON_SRC` varchar(100) DEFAULT 'http://54.162.237.63/public/images/bouclier.png'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
-- UPDATE `UTILISATEUR` SET `PDP_SRC` = 'http://54.162.237.63/public/images/Icone1.png' WHERE `UTILISATEUR`.`UTILISATEUR_ID` = 1;
-- UPDATE `UTILISATEUR` SET `PDP_SRC` = 'http://54.162.237.63/public/images/Icone2.png' WHERE `UTILISATEUR`.`UTILISATEUR_ID` = 2;
-- UPDATE `UTILISATEUR` SET `PDP_SRC` = 'http://54.162.237.63/public/images/Icone3.png' WHERE `UTILISATEUR`.`UTILISATEUR_ID` = 3;
-- UPDATE `UTILISATEUR` SET `PDP_SRC` = 'http://54.162.237.63/public/images/Icone4.png' WHERE `UTILISATEUR`.`UTILISATEUR_ID` = 4;
-- UPDATE `UTILISATEUR` SET `PDP_SRC` = 'http://54.162.237.63/public/images/Icone5.png' WHERE `UTILISATEUR`.`UTILISATEUR_ID` = 10;
-- UPDATE `UTILISATEUR` SET `PDP_SRC` = 'http://54.162.237.63/public/images/Icone6.png' WHERE `UTILISATEUR`.`UTILISATEUR_ID` = 11;
-- UPDATE `UTILISATEUR` SET `PDP_SRC` = 'http://54.162.237.63/public/images/Icone7.png' WHERE `UTILISATEUR`.`UTILISATEUR_ID` = 12;
